...
/usr/local/bin/ffmpeg -framerate 1/${time_per_frame:0:6} -pattern_type glob -i 'job/'$1'/resized/*.jpg'  -i 'job/'$1'/out-master.mp3' -c:v libx264 -pix_fmt yuv420p -loglevel warning 'job/'$1'/master.mp4' >> /dev/null
